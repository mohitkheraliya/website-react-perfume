...
const Footer = () => {
  return (
    <footer class="footer w-full py-14 mb:py-10">
      <div class="mx-auto max-w-7xl px-4">
        <div class="max-w-3xl mx-auto">
          <div className="w-[25rem] h-[15rem] flex justify-center items-center mx-auto mb:w-[20rem] xsmall:w-[20rem]">
            <img
          ...
          <ul class="text-[1.7rem] flex items-center justify-center flex-row gap-32 md:flex-row transition-all duration-500 py-12 mb-2 tab-sm:flex-col tab-sm:gap-10 tab-sm:py-6">
            <li>
          ...
          <div class="flex items-center justify-center mb-10">
            <div className="w-full h-auto py-4 flex items-center justify-center gap-10 flex-wrap">
              <a
                href="https://www.facebook.com/profile.php?id=61550510295193"
                target="_blank"
                rel="noopener noreferrer"
              >
                <button class="w-14 h-14 flex items-center justify-center rounded-[50%] shadow-md border border-gray-300 p-2 group transition-all duration-300 hover:border-blue-500">
                  <svg
              ...
              <a
                href="https://www.instagram.com/angel_perfumery_pop"
                target="_blank"
                rel="noopener noreferrer"
              >
                <button class="w-14 h-14 flex items-center justify-center rounded-[50%] shadow-md border border-gray-300 p-2 group transition-all duration-300 hover:border-blue-500">
              ...
              <a
                href="http://api.whatsapp.com/send?phone=919512891212"
                target="_blank"
                rel="noopener noreferrer"
              >
                <button class="w-14 h-14 flex items-center justify-center rounded-[50%] shadow-md border border-gray-300 p-2 group transition-all duration-300 hover:border-blue-500">
          ...
          <span class="text-md text-gray-500 text-center block">
            ©<a href="https://pagedone.io/">angelperfumery</a> 2025, All rights
            reserved.
          </span>
        </div>
      </div>
